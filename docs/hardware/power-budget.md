...
|---|---|---|---|---|
| **125 kHz**（ADPS 7。**既定**） | 9616.4 Sample/s | **4808.2 Sample/s** | 0 | **規定内** |
| 250 kHz（ADPS 6） | 19229.0 Sample/s | 9614.5 Sample/s | 0 | **規定外。分解能を落とす取引になる** |
...
**baud 115200では取りこぼしが出る**（transportが律速。1 sampleあたり2.164 Bを要するため
実効約11.52 kB/sでは約5.3 kSample/sが上限になる）。**測定にはbaud 500000以上を使う。**
