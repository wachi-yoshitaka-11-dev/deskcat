...
（[hardware-bom.md](hardware-bom.md) `RES-PULL-01`）。**確定した4本は 4.7 kΩ×1 と 10 kΩ×3 であり、追加の発注は要らない。**
